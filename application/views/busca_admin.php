    ...
    <body>
        <div id="main">
            ...
            <div id="site_content">
                ...
                <div class="content">
                    <center>
                        <h1>Busca Avaliacao</h1>
                        <?php
                        echo form_open('admin/mostrarAvaliacao');
                        echo form_dropdown('estados', $estados, 'RS', 'id="estados" width = "200" style="width: 200px"');
                        echo '<br><br>';
                        echo form_dropdown('cidades', array('1' => ''), '1', 'id="cidades" width = "200" style="width: 200px"');
                        echo '<br><br>';
                        echo form_dropdown('escolas', array('1' => ''), '1', 'id="escolas" width = "200" style="width: 200px"');
                        echo '<br><br>';
