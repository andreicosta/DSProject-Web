          ...
          <div class="well sidebar-nav">
            ...
            <div class="container1">
               <div class="row-fluid1">
                   <form method="POST" action="<?php echo base_url();?>escola/remove">
                     <fieldset>
                     
                     <!-- Form Name -->
                     <legend>Remover Escola</legend>
                     ...
                     <div class="control-group">
                       ...
                       <div class="controls">
                            ...
                            <?php echo form_dropdown('idEscola', $escolas, '', 'id="escolas" class="input-xlarge"') ?>
                       </div>
                     </div>
                     ...
                     <div class="control-group">
                       ...
                       <div class="controls">
                         <button type="Submit" id="removerButton" name="removerButton" class="btn btn-default" value="RemoverEscola">Remover</button>
                       </div>
                     </div>
