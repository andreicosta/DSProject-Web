            ...
            <div id="site_content">
                ...
                <div class="content">
                    <center>
                        ...
                        <?php
                        echo 'Selecione faixa pesquisa';
                        echo form_open('admin/adm_filtrafaixa');
                        echo form_label('Faixa Etaria');
                        $options = array(    
                                        '10'    => '10',
                                        '11'    => '11',
                                        '12'    => '12',
                        ...
                        echo form_dropdown('myfilter', $options, '10');                          
                            echo form_submit('filtrarfaixa','Enter');
                        echo form_close();
                        ?>
                        <script>
                            jQuery(function($) {
